...
const polonius = {
  ...
  scales: {
    tiredness: {
      ...
      bands: [
        ...
        { at: 8,  word: 'heavy-lidded' },
        { at: 12, word: 'sinking' },
        { at: 16, word: 'sliding under' },
        { at: 19, word: 'going' },
      ],
      crossUp: {
        2: 'My shoulders have dropped without my deciding to drop them.',
        3: 'I count the sconces to keep my eyes in use. I lose the count at four.',
        4: '!!I can hear my own pulse. It is slower than it should be.!!',
        5: '!!The lamps are further away than the walls they hang on. I am going.!!',
      },
      crossDown: {
    ...
    intimacy: {
      ...
      bands: [
        { at: 0,  word: 'a guest' },
        { at: 4,  word: 'noticed' },
        { at: 8,  word: 'attended to' },
        { at: 12, word: 'studied' },
        { at: 16, word: 'preferred' },
        { at: 19, word: 'chosen' },
      ],
      crossUp: {
        2: 'His eyes stay on me one beat past politeness. I count the beat.',
        3: 'He has stopped looking at the fire. There is one other thing in the room to look at.',
        4: '!!He knows the shape of my breathing.!!',
        5: '!!He is reading me the way a collector reads a hallmark.!!',
      },
    },
    unease: {
      ...
      crossUp: {
        2: 'His smile is on time. His eyes arrive late.',
        3: 'Two wrong details now. I am keeping the count.',
        4: '!!This is not a young man. This is a thing that keeps one.!!',
        5: '!!He is older than the room. The room is older than the hospital. I am the newest thing in the house.!!',
      },
    },
  },
  ...
  fileReveals: [
    { at: 6,  announce: 'A line fills in. Subject was entered in the register the day the wing was annexed. The same hand entered both.' },
    { at: 14, announce: 'Another. The staff draw no wages. No ledger in the hospital has ever paid for that house\'s candles.' },
    { at: 22, announce: '!!The wing door reads the admission card. There is no handle on the inside.!!' },
    { at: 32, announce: 'The last line. Staff who entered alone have ~~not returned~~ been **retained**.' },
  ],
  ...
  presented(p, hub) {
    ...
    const desc = {
      foyer:      noticed
        ? 'The foyer again. The coat-tree, the clock, the small fire. I make it nine paces from the parlor door to the front door. On my first crossing it was seven.'
        : 'The foyer is panelled in dark wood gone soft with beeswax. A coat-tree, three pegs, no coats. A grandfather clock. A small fire in an iron grate. The room is warm the way a held hand is warm.',
      parlor:     noticed
        ? 'The parlor is hot. The fire has been at the same log all evening, and the log is whole. Two armchairs face it. The decanter, the bust, the iron poker by the grate.'
        : 'The parlor is warm. A small fire, two armchairs faced to it, a decanter on the side table, a bronze bust on the mantel, an iron poker leaning at the grate.',
      library:    'Shelves floor to ceiling. Calf, cloth, and bindings I do not put a name to. A reading lamp, a lectern. The spines are sun-faded. There is no window in this room.',
      gallery:    'A narrow hall of portraits — every century of collar and cuff. The last frame on the row is empty, and the wall behind it has not had time to fade.',
      clock_hall: 'A hall with the tall clock at its end. The pendulum swings; the face has no hands to show for it. Two corridors branch toward the back rooms.',
      dining:     'A long table laid for two. The candles burn; the wax has pooled in the holders, but the candles are no shorter. The cook stands in the doorway in his apron.',
      hall:       'A corridor of closed doors, the wallpaper a shade darker at each lamp. Six doors. I had counted five.',
      bedroom:    'A guest room. The bed is turned down. The window is brick under paint, and the painted sky holds constellations that are not mine.',
      kitchen:    'The kitchen. The great range, the block of knives, the pantry door, the narrower door in the back wall. A pot steams over a burner that is not lit.',
      cloakroom:  'A small cloakroom at the back of the house. Three coat-hooks and a shelf. The two coats that are not mine are warm.',
      study:      'A small study. A desk, a shelf of ledgers, a locked drawer. The window is paint over brick, finished down to a painted latch.',
      cellar:     'The wine cellar. Cold rows of bottles under old wax. The dust lies even everywhere but the third row.',
    ...
    if (p.flags._mask_on === false) {
      ...
      tail = ' He is still courteous. The courtesy has stopped being a manner and become a grip.';
    } else if (poloniusWondering(p)) {
      tail = ' He attends me the way a collector attends a new arrival. Where to put it. How to keep it.';
    } else if (poloniusNoticed(p)) {
      tail = ' He is polite. He stands the way the furniture stands: placed.';
    } else {
  ...
  spokes: {
    main: {
      ...
      nodes: {
        ...
        t_arrival: {
          lines: [
            'He inclines his head. Polonius, sir. You will forgive the ceremony — the wing keeps its manners the way other houses keep plate. We have so few occasions to bring them out.',
            'He turns an open hand toward the inner doorway. Do come through. The parlor is warmer, and the kettle has been on, he says, since shortly before I arrived.',
          ],
          choices: [
        ...
        t_his_name: {
          lines: [
            ...
            'He brightens. A small formal bow. Polonius, yes. Greek. The name has held up better than anything else I brought with me.',
            'He smiles. I would offer my hand, sir, but I am told my hands are cold this evening. I will spare you the courtesy.',
            'He turns again to the inner doorway. Come through. The house does better by a seated guest.',
          ],
        ...
        t_where_am_i: {
          lines: [
            ...
            'He inclines his head. The Greek Wing, sir. Annexed to the south of the hospital. You will not find it on the printed maps. It has always been here without ever being noted, which is a talent some houses have.',
            'He pauses, fond. The house is older than the hospital. The hospital was built around it, the way flesh closes around a splinter. I am the only **resident**.',
            'He turns to the inner doorway. But — come in. I would not keep a guest in a hallway.',
          ],
        ...
        t_house_age: {
          lines: [
            ...
            'Old, sir. The wing has stood here in one form or another since the first hospital chapel went up beside it. The house itself was moved here — a man with the means to move a house had it moved.',
            'He smiles, with a small fondness. A very long time ago.',
            'He says it twice. The second saying is not addressed to me.',
          ],
        ...
        t_who_moved_house: {
          lines: [
            ...
            'He shrugs — a fond gesture, the gesture of a man dusting off an answer kept on a high shelf.',
            'A man of means, sir. His name has kept less well than mine. He had the house taken apart in numbered beams and re-set where you are standing, by masons paid in gold.',
            'He smiles. Not one of the masons took a second commission. Gold goes further, sir, when the spending of it is brief.',
          ],
        ...
        t_obs_clock: {
          lines: [
            'I cross to the grandfather clock. Dark oak, beeswaxed. The pendulum swings. I can hear the mechanism in the case, wound and waiting.',
            'I look at the face. The numerals are all present. The hands are not. The brass centre where they should sit is worn smooth as a coin rubbed blank.',
            'I look back at Polonius. He has not remarked on it. He watches me the way a portrait watches a room.',
          ],
        ...
        t_ask_clock: {
          lines: [
            ...
            'He pauses. The line has the polish of long handling. It does not have any grief in it.',
          ],
        ...
        t_obs_painting: {
          lines: [
            'I look at the painting. A hillside, ochre, late afternoon. A man and a small white dog in the foreground.',
            'The man wears a chiton. I have seen chitons on red-figure pottery. I have not seen one in Victorian gilt.',
            'I read the brushwork. The paint is recent. The clothes are some twenty-five centuries older than the paint.',
            'Polonius, behind me: Most do not stop for that one, sir. The hills are in the south of Greece. The dog was real, once.',
          ],
        ...
        t_obs_wallpaper: {
          lines: [
            'I run a fingertip along the wallpaper. Green velvet, a small laurel repeating, the sheen of fabric brushed often and recently.',
            'I look for the seam between two strips. I find one. I look for the next. There is no next.',
            'A house this old should have seams I can count. The paper is old in pattern and new in fact.',
          ],
        ...
        t_obs_coat_tree: {
          lines: [
            'I cross to the coat-tree. Dark wood, polished, old. Three pegs, and a small mirror set into the upright, the size of a hand.',
            'No coats on the pegs. I check the floor where a wet coat would have dripped. The boards are dry. The boards have been dry for a long time.',
            'I look in the mirror. The foyer, Polonius, me. He is studying the back of my head the way one studies a marked page.',
          ],
        ...
        t_obs_door_behind: {
          lines: [
            'I look back at the door I came through. The brass slot sits at chest height. Below it, wood. Above it, wood.',
            'I look for the handle. I look twice. The door is set into the wallpaper without one — no knob, no latch, no keyhole.',
            'I put my hand to the slot. It is the kind a card slides into. It is the only mechanism on this side of the house.',
        ...
        t_obs_hands_asked: {
          lines: [
            ...
            'Quirks. He sets the word down gently, like good china he did not buy.',
          ],
        ...
        t_ask_about_noticed: {
          ...
          choices: [
            ...
            },
            {
              ...
              goto: { to: 't_look_around', lines: ['I say: the painting. The man is in a chiton. The frame is Victorian.', 'He nods, fond. You have a good eye, sir. The painting was made for the man who lives in it. He is — he was — a friend of the house. The frame I had made later.', 'He said lives. ~~He misspoke.~~ He corrected himself, which is not the same thing.'], flags: { _heard_origin: true }, scales: { intimacy: +1, unease: +1 } },
            },
            {
              label: 'the wallpaper — it is too new',
              when: (p) => p.flags._obs_wallpaper_too_new,
              goto: { to: 't_look_around', lines: ['I say: the wallpaper. One seam. A house this old should be all seams.', 'He smiles. Mrs. Halliwell is meticulous, sir. She re-hangs the paper. She has re-hung it for a long time. I have never had the heart to ask her how often.'], scales: { intimacy: +1, unease: +1 } },
            },
            {
        ...
        t_step_inside: {
          lines: [
            'I step through the inner doorway. He follows me through, and then he is ahead of me. I did not see the overtaking.',
        ...
        l_should_go: {
          lines: [
            ...
            'Polonius looks up from his cup. He nods, fond. Of course, sir. The evening has been a pleasure. Allow me only to send Mrs. Halliwell for your card.',
            'He turns toward the inner doorway. Mrs. Halliwell — the gentleman\'s card, if you please.',
            'No answer comes back. For the first time all evening, the staff are not ahead of the request.',
          ],
        ...
        l_polonius_apologises: {
          lines: [
            ...
            'Polonius\'s smile gives a fraction — the embarrassment of a man whose servant is a half-second late, nothing more.',
            'Forgive me, sir. The cloakroom is — he consults a pocket watch with no hands on it — locked at this hour. The keys are with Mr. Halliwell, in the parlor. He keeps them of an evening.',
            'He adds, with the same patient courtesy: the parlor is the second door from the end of the corridor. Mr. Halliwell will be obliging.',
            'I draw the map he has just given me. My card at the back of the house. The keys in the middle. Me at the front, holding a teacup.',
          ],
        ...
        l_try_door: {
          lines: [
            ...
            'The front door. The brass slot at chest height. I push. The door takes my weight and gives back none of it.',
            'I run my hand around the frame, both sides, top to sill. There is the slot, and there is the door, and there is the wood. My hands go around a second time without my asking them to.',
            'I press my palm to the slot. The slot does not read palms. The slot reads cards.',
            'Behind me, Polonius is at the parlor doorway. He has not crossed into the foyer. He is letting me discover this without an audience. It is the most courteous thing he has done all evening.',
          ],
        ...
        l_press_forehead: {
          lines: [
            'I press my forehead to the wood. It is the same wood it was from the corridor side. It is warmer from this side.',
            'I close my eyes. I count to four. I open them.',
            'I turn back. Polonius is in the parlor doorway. He has not moved. He has watched this scene from this distance before, and is too courteous to say how many times.',
        ...
        l_demand_card: {
          lines: [
            ...
            'He pauses, with the consideration of a man handing over a small unwanted piece of news.',
            'The parlor is the second door from the end of the corridor. I would lead you, but I am better company over a threshold than I am as a guide. You will reach it. Mr. Halliwell is obliging.',
          ],
          flags: { _heard_card_in_cloakroom: true, _heard_parlor_keys: true, _heard_keys_butler: true, _aware_locked: true },
          scales: { intimacy: +1 },
          choices: [
        ...
        l_why_like_this: {
          lines: [
            ...
            'He smiles, small and tired. I am being honest because I cannot afford the polite version. The house is patient. It is also hungry. I would like the meal to last a while.',
            'The word he used was ~~evening~~ meal.',
          ],
        ...
        r_clock_hall: {
          lines: [
            'A short hall ending in the tall clock. The pendulum swings. The face has no hands.',
            'I stand in front of it. If the house has a face, this is the face: wound, working, and refusing to say.',
            'Two corridors branch off the hall. One curves toward the back of the house. One drops away — a narrow stair that was not in my first count of the stairs.',
        ...
        r_clock_branch: {
          ...
          lines: [
            'I weigh the two corridors. One curves toward the back of the house, and the wallpaper darkens into it. One drops by a narrow stair, and the cold comes up the stone to meet me.',
          ],
          choices: [
        ...
        r_clock_watch: {
          lines: [
            'I put my back to the wall of the clock hall and stand the way the coat-tree stands. The staff do not read furniture.',
            'After a minute, Mrs. Halliwell crosses front-to-back, smiling at the empty corridor ahead of her, carrying a small pale thing. She goes down toward the cloakroom.',
            'A minute later she returns. Her hands are empty. The smile has not been put away.',
            'Later, Mr. Halliwell crosses from the parlor toward the back, all of himself turning at the corner, carrying a small pale thing in his turn. He stops at a door with a brass plate. The plate reads: Study.',
            'The pendulum keeps time the clock refuses to tell.',
          ],
        ...
        r_clock_face: {
          lines: [
            'I lean in close to the face. The hours are inked. The hands are gone. At the centre, set into the wood, is a small piece of brass with an opening in it.',
            'I measure the opening with my eye. It is the width of an admission card.',
            'The house has a face, and the face has a mouth, and the mouth is held open.',
        ...
        r_clock_back_corridor: {
          lines: [
            'I follow the back corridor along the rear of the house. The wallpaper is darkest here, the green gone nearly to black.',
            'A door with a brass plate. I read the plate: Study. The door is closed.',
            'Further on, a smaller door painted the colour of the wallpaper, no plate, and a band of wear in the wood at the height of a tray carried on a hip.',
            'A door used hourly by a woman with her hands full. The cloakroom.',
          ],
        ...
        r_clock_descend: {
          lines: [
            'I take the stair down. Narrow. The wood speaks at the third step and again at the seventh; I file the two steps for the climb back. The descent ends in a dim chamber and a door set into stone.',
            'The cellar door.',
            'Above me, on the landing, the cook is standing. He did not follow me down. He was already there. He watches me reach the bottom, and his hands go on wiping themselves on the apron without him.',
          ],
        ...
        r_clock_cook_intercepts: {
          lines: [
            'I climb back to the landing. The cook stops me with a hand. The hand is bigger than I had budgeted for. The other hand goes on working at the apron, on its own time.',
            'Sir, he says, quietly. The voice has a north in it, and the eyes have the lights on. For the moment, no part of him belongs to the day.',
            'The cellar is fine, sir. There is a shelf. There is a shard. The shard is what holds him. I have done the wines forty-one years. I have looked at that shard every time and put the bottle back in front of it.',
            'He pauses. Sir. If I am out of the kitchen above a minute, the day takes me back, and this conversation goes with it. Go down. I will not stop you. The master cannot stop you on the stair.',
          ],
        ...
        r_dining_eat: {
          lines: [
            'I sit. The chair has been warmed. The food is hot. The cook stands in the doorway, watching me eat, hands working at the apron.',
            'I take a bite. It is very good, and it tastes of a meal I have eaten before — the exact meal, down to the year. The wine is poured before I have asked.',
            'Polonius sits across the table. He is not eating. His knife and fork lie on the plate at an angle no human elbow produces. He watches me eat the way one watches a fire take.',
          ],
          ...
          choices: [
            {
              ...
              goto: { to: 'r_dining', lines: ['I set the knife and fork down, crossed, the way my mother taught me to refuse seconds. The cook makes a small unhappy sound in the doorway.', 'Polonius nods. As you wish, sir. The cook will save it. The cook saves everything.'], scales: { tiredness: -1, intimacy: -1 }, composure: +1, composureGain: 'I stopped while stopping was mine to do.' },
            },
            {
        ...
        r_dining_finish: {
          lines: [
            'I finish the plate. The cook is delighted. The bow he gives me is the first thing in this room that is not a performance.',
            'I push up from the table. The chair holds on for one beat past furniture.',
            'My limbs are slow. The wine has settled into them like a tenant. I will need to walk this off.',
          ],
        ...
        r_dining_blood: {
          lines: [
            ...
            'The cook looks down at the apron as if it had been handed to him mid-sentence. Polonius, mild: The lamb, sir. He prepared lamb. He has always been a thorough butcher.',
            'The cook nods. He is still in the doorway behind me. He has not moved. His hands have not stopped.',
            'I read the apron the way I read the register. Stains in inks of different ages. The newest is very new.',
          ],
          scales: { unease: +3 },
        ...
        r_dining_speak_cook: {
          lines: [
            'I cross to the cook in the doorway. I keep my voice under the candle-hiss.',
            'I say: I need to leave. The card. The shard. Any of it.',
            'The smile is fixed. The eyes do not move. He says, in the same fixed voice: the lamb, sir. The lamb is very good.',
            'In this room he is a sideboard with a voice. Whatever woke in him on the stair does not wake at this table.',
            ...
            'The kitchen. Polonius has just told me where his own staff goes to be disloyal. I do not know yet what that costs him, or me.',
          ],
        ...
        r_dining_take_cleaver: {
          lines: [
            'I reach for the cleaver at his waist. His hand intercepts mine — the house\'s grip again, fixed, strong, sorry.',
            'Sir, he says, in the dining-room voice. The cleaver is for the lamb. The cleaver does not leave the cook.',
            'He releases me. He bows. The cleaver stays at his waist, riding the bow.',
            'In this room the rules wear him. I will have to ask him where the rules are thinner.',
        ...
        r_dining_decline: {
          lines: [
            ...
            'The cook does not leave. He stands in the doorway behind me, hands working, like a clock that has been told to wait.',
          ],
          scales: { unease: +1 },
          composure: +1,
        ...
        r_cloakroom_approach: {
          lines: [
            'I walk to the back of the corridor. The smaller door sits in the wallpaper like a page in a book. Above the handle, in brass: a small lock.',
            'The maid is in front of the door, smiling before I have given her a reason. She is not blocking. She is, however, in the way.',
          ],
          flags: { room: 'hall' },
          choices: [
            {
        ...
        r_cloakroom_locked: {
          lines: [
            'I try the handle. The handle turns; the lock holds. A small lock. A sufficient lock.',
            'The maid, beside me: Locked, sir. Mr. Halliwell has the key.',
            'She does not smile less. She does not smile more. The smile is a fixture, like the sconces.',
          ],
        ...
        r_cloakroom_ask_maid: {
          lines: [
            ...
            'She does. Of course, sir. She moves a quarter-step. The door is still there. So is she. She has, in moving aside, come to occupy more of the doorframe.',
            'I move past her. Her hand brushes my sleeve — brief, careful, the same brush as the coat. The smile was already in place when I decided to move.',
            'She has been rearranged, the way furniture is rearranged: to improve the room\'s defence of itself.',
          ],
          scales: { unease: +2, intimacy: +1 },
          choices: [
            {
        ...
        r_cloakroom_slip: {
          lines: [
            'I feint right and go left. She does not follow the feint. She does not need to. She was smiling at the left before I chose it.',
            'Her hand is at my forearm. The grip is far stronger than the body it is attached to.',
            'I have tried this once. She has prevented it a thousand mornings.',
        ...
        r_cloakroom_unlock: {
          lines: [
            'I take out the keys. Brass head to brass lock. The lock turns over once, softly, like a sleeper.',
            'I step inside. The maid does not follow. She stands at the threshold, smiling into the small room. Whatever her day is made of, it stops at this jamb.',
            'The cloakroom is small. My coat is on a hook. Two other coats hang beside it — I do not know them. I touch one in passing. It is warm.',
          ],
        ...
        r_cloakroom_search_coat: {
          lines: [
            'I take down my coat. I go for the inner pocket, the one I would use. My fingers find the seam —',
          ],
          choices: [
            {
              label: 'look',
        ...
        r_cloakroom_card_in_coat: {
          lines: [
            'The pocket is heavier than empty. I bring out my admission card. I read the number twice. The number is mine.',
            '!!I have it.!!',
            'I put the coat on. Of the three coats on the rail, mine is the only one at room temperature.',
            'Behind me, at the threshold, Mrs. Halliwell\'s smile has already widened. Whatever it is ahead of has not happened yet.',
          ],
        ...
        r_cloakroom_coat_empty: {
          lines: [
            'The pocket is empty. The card was placed here. The card has been moved on.',
            'I check the other coats — the warm ones. Pockets empty. Pockets emptied, by the feel of the turned linings.',
            'I am minutes behind. The maid carries it in; the butler carries it deeper. The house digests by stages.',
            'Behind me, at the threshold, Mrs. Halliwell\'s smile is exactly where it was.',
          ],
        ...
        r_cloakroom_search_shelf: {
          lines: [
            'I run my hand along the shelf. Dust, then tin. No card. A small tin box. I open it.',
            'Inside: forty-one folded slips of paper, one size, one shape, a name on each. I know the names. They hang in the gallery.',
            'At the bottom of the tin, where a forty-second slip would go, lies a blank one. A pen waits on the shelf beside the tin.',
            'My name has an appointment. The stationery is already bought.',
          ],
          ...
          choices: [
            {
              ...
              goto: { to: 'r_cloakroom_unlock', lines: ['I take the blank slip and fold it into my pocket. A name not yet written is a thing not yet filed. I will keep the paperwork incomplete.'], flags: { _have_blank_slip: true }, composure: +1, composureGain: 'His next move is in my pocket.' },
            },
            {
        ...
        l_drift: {
          lines: [
            ...
            'When I open them — when I open them — Polonius is closer. He is in the chair beside me, and there was no chair beside me when I closed my eyes.',
            '!!I did not hear furniture.!!',
            'He says, very softly: Sleep, sir. The house will see to the rest. The house will see to.',
          ],
          composure: -3,
          ...
          choices: [
            {
              ...
              goto: { to: 'hub_corridor', lines: ['I stand up out of the comfort the way one steps out of deep water. The chair gives me back by inches. I leave the parlor without looking at him.'], scales: { tiredness: -4 }, composure: +2, composureGain: 'I am on my feet. The feet are mine.' },
            },
            {
            ...
            },
            {
              ...
              goto: { to: 'end_slept', lines: ['I close my eyes. Just another moment. The chair is warm. He is humming, very softly, in a language nobody has been born into for a long time.'], flags: { _slept: true } },
            },
          ],
        },
        ...
        l_offered_bed: {
          lines: [
            'He stands. He gestures down a corridor that was not in my count of the corridors.',
            'There is a guest room, sir. The bed is made. The bed has been made a long time. I would not be a host worth the name if I did not at least offer.',
            'The corridor he is offering is darker than the others, and the lamps in it are already lit, as though the house had voted before I did.',
          ],
          scales: { tiredness: +2 },
          choices: [
            {
            ...
            },
            {
              ...
              goto: { to: 'hub_corridor', lines: ['I say: no, thank you. I really must be going.'], scales: { intimacy: -1 }, composure: +1, composureGain: 'I did not follow him down the lit corridor.' },
            },
            {
              label: 'tell him you will not sleep in this house',
              goto: { to: 'hub_corridor', lines: ['I say: I am not going to fall asleep in this house.', 'He smiles, small and tired. As you wish, sir. As you wish. The lamps in the offered corridor go out, one after another, without being touched.'], scales: { unease: +2 }, composure: +1, composureGain: 'I said it out loud, where the house could hear it.' },
            },
          ],
        },
        ...
        l_bedroom: {
          lines: [
            'The room is small and warm. The window is brick under paint, painted down to the night sky in it — constellations that are wrong, or very old, or both.',
          ...
          choices: [
            {
              label: 'lie down',
              goto: { to: 'end_slept', lines: ['I lie down. Just for a moment, I tell myself. Just to arrange my thinking. The pillow has already been dented to the shape of a head.'], flags: { _slept: true } },
            },
            {
              label: 'try the door',
              goto: 'l_bedroom_door',
        ...
        l_bedroom_door: {
          lines: [
            ...
            'The corridor outside is empty. The lamps have burned low. A door he does not need to lock is a door he trusts.',
          ],
          choices: [
            {
              label: 'leave the room; back to the corridor',
              goto: { to: 'hub_corridor', lines: ['I step out. I do not look at the bed on the way. Looking is the first instalment.'], composure: +1, composureGain: 'I did not sit down on it.' },
            },
            {
        ...
        l_bedroom_window: {
          lines: [
            'The window is brick. I touch the painted sky. Paint over brick over more brick. I rap it with a knuckle: the sound of a wall.',
            'In the painting, on the far hill, a small figure is standing. It is facing the room. I have read this painting once already, and the hill was empty.',
          ],
          scales: { unease: +3 },
          composure: -2,
          composureCost: 'The hill was empty the first time.',
          choices: [
            { label: 'try the door', goto: 'l_bedroom_door' },
            { label: 'lie down', goto: { to: 'end_slept', lines: ['I lie down. The bed accepts me without negotiation.'], flags: { _slept: true } } },
          ],
        },
  ...
  endings: [
    // Order matters — more specific endings come first.
    {
      ...
      lines: [
        'I am in the hospital corridor. The lights are too bright after a night of oil. My coat is on. My card is in my pocket. There is no blood on me anywhere; I check twice.',
        'I look back. A wall stands where the door was, wearing the dust of a wall that has always been a wall.',
        'I walk back to the ward. I will tell no one. There is no one left to be told about.',
        'In my pocket: two pieces of broken clay. There was a name across them. The name has gone where the clockmaker went, where the masons went, where he went. Out.',
      ],
      item: 'small_bell',
    },

    {
      ...
      lines: [
        'I am in the corridor. The hospital lights are very bright. My own breath is loud in my ears, and it is mine, and I count it going in and out like money.',
        'Under one fingernail, a smear of him. The wrong colour, with the wrong shine. I do not look at it for long.',
        'My card is in my pocket. The slot read it. Doors are honest; it is only houses that lie.',
        'I look back. Plaster, the way a doorway is plaster when there has never been a doorway.',
        'I walk to the ward without stopping to wash my hand. The night nurse will not ask. It is not the kind of building where they ask.',
      ],
...

    {
      ...
      lines: [
        'The weapon is still in my hand. ~~I remember every blow.~~ I do not remember the last few.',
        'My card is in my pocket. Body or drawer — I retrieved it from one of them. The order of the hour has gone soft in the middle.',
        'The corridor is bright. The night nurse is at her station. Her face closes like a file.',
        'I do not remember what I tell her. I remember that she stops me at the ward door and says, very quietly: !!There is no Greek Wing, sir. There has never been a Greek Wing. Are you alright.!!',
        'I am holding a thing from a house that does not exist. It is heavy. There is blood on it, and the blood is older than blood gets.',
      ],
      item: 'sliver_of_glass',
      scars: ['named'],
    },

    {
      ...
      lines: [
        'I am in the corridor. The hospital lights are too bright after the lamps. My card is in my pocket, one corner bent where the slot held it a moment longer than it needed to.',
        'I look back. Plaster, the way a doorway is plaster when there has never been a doorway.',
        'I walk back to the ward. I will not tell anyone. They would not believe me. I would not believe me.',
        'He is still in the house. The register has space below my name, and the kettle will be on before the forty-third guest has decided to visit.',
      ],
      item: 'small_bell',
    },

    {
      ...
      lines: [
        'His hand is on my throat. The hand is the temperature of the cellar.',
        'He says, very close to my ear, in a language that has not been spoken on this floor: καλά. Πολύ καλά.',
        'He sets me down with the care one spends on a thing one will need again.',
        'The maid is there with a sheet, smiling at work she has not been given yet. The sheet is already folded to my length.',
      ],
      item: null,
...

    {
      ...
      lines: [
        ...
        'When I open them the room is the same. The fire is the same. The fire is exactly the same. Polonius is gone.',
        'The maid is in the doorway, already smiling. Good morning, sir. You slept very well. The master is out for the day. He left at dawn, in very good spirits.',
        '!!I rise. The chair gives me up at once, the way a thing is released to its owner. My limbs are heavy, and they are mine in a way they were not yesterday.!!',
        'The card is on the side table. The door is just there. The door has no handle on this side, and I find I no longer mind, and the not minding is the curse, arriving on time.',
      ],
      item: null,
      scars: ['collapsed', 'named'],
    },

    {
      ...
      lines: [
        'I sit in the chair by the fire. The fire does not go down. The fire does not go up. The log declines to be spent.',
        'I do not know how long I sit. I count to one hundred several times. The counts do not add up to anything that has a name.',
        'When the door opens it is the maid, with tea, smiling — and the smile got here before the tray did.',
        'You\'ll be wanting your supper, sir. The cook has prepared it. The cook has been preparing it a long time.',
      ],
      item: null,
      scars: ['collapsed'],
    },

    {
      ...
      lines: [
        'He is in the corridor. The hospital lights are on him, and he is laughing into them like a man drinking.',
        'My foot will not cross the threshold. The doorway is open in front of me and it is a wall. ~~I am the one who came in.~~ I am the one who came in.',
        'The maid is at my elbow, taking my coat. The house will take your coat, she says. The house will take.',
        'Welcome home, sir. The master will be back in the morning. He will be sorry to have missed you, but very pleased to find you here.',
      ],
      item: null,
      scars: ['collapsed', 'named'],
    },
